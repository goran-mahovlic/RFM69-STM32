...
// **********************************************************************************
#ifndef RFM69_ATC_STM32_h
#define RFM69_ATC_STM32_h
#include <RFM69STM32.h>

#define RFM69_CTL_RESERVE1  0x20

class RFM69_ATC_STM32: public RFM69STM32 {
  public:
    ...
    RFM69_ATC_STM32(uint8_t slaveSelectPin=RF69_SPI_CS, uint8_t interruptPin=RF69_IRQ_PIN, bool isRFM69HW=false, uint8_t interruptNum=RF69_IRQ_NUM) :
      RFM69STM32(slaveSelectPin, interruptPin, isRFM69HW, interruptNum) {
    }

    bool initialize(uint8_t spiPort, uint8_t freqBand, uint8_t ID, uint8_t networkID=1);
